...
public class ResumeControllerTest {
    ...
    @Test
    public void givenResumeControllerWhenResumingGameThenIsCorrect() {
    ...
    @Test
    public void givenResumeControllerWhenResettingGameThenStateIsBackToInitial() {
        assertEquals(StateValue.INITIAL, this.state.getValueState());
        resumeController.next();
        assertEquals(StateValue.IN_GAME, this.state.getValueState());
    ...
    public void givenResumeControllerWhenResumingAEndedGameThenItFails() {
        assertEquals(StateValue.INITIAL, this.state.getValueState());
        resumeController.next();
        assertEquals(StateValue.IN_GAME, this.state.getValueState());
        resumeController.next();
